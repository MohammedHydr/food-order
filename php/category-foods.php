    ...
    <?php 
        if(!isset($_GET['category_id']))
            ...
            $category_id = strip_tags(addslashes($_GET['category_id']));

            $con=mysqli_connect("localhost","id18276735_foodo", "q%0/x2tz^\fP#J?b","id18276735_foodorder");
    ...
    <section class="food-search">
        <div class="container">
            ...
            <h2><a href="#" class="search">Foods on "<?php echo $category_title; ?>"</a></h2>
